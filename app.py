...
def run():
    ...
    # If Else for crypto or stocks and forecast or indicators (maybe both?)
    # Create broker for crypto get bars stuff. Create second API caller for crypto
    # Create indicator option or automatically include. Options for indicators
    # pandas TA
